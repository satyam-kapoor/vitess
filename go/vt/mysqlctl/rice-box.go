...
func init() {
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1578087536, 0),
	...
	dirh := &embedded.EmbeddedDir{
		Filename:   "zkcfg",
		DirModTime: time.Unix(1562731123, 0),
		ChildFiles: []*embedded.EmbeddedFile{
			filei, // "zkcfg/zoo.cfg"
